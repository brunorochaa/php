...
<html lang="pt-br">
    ...
    <body>
        ...
        <form name="cadastro" method="post" action="control/control.php">
            ...
            <div class="form-group">
                <input type="text" name="cep" placeholder="cep *com . e -*" pattern="[0-9]{2}.[0-9]{3}-[0-9]{3}" required value="<?php if(isset($post)) echo $post['cep']; ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="telefone" placeholder="telefone" pattern="[0-9]{2,3}[0-9]{8,16}" required value="<?php if(isset($post)) echo $post['telefone']; ?>">
            </div>
            <div class="form-group">
