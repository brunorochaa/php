...
<html lang="pt-br">
    ...
    <body>
        ...
        <form name="alterar" method="post" action="alterar.php">
            ...
            <div class="form-group">
                <input type="text" name="cep" placeholder="cep *com . e -*" pattern="[0-9]{2}.[0-9]{3}-[0-9]{3}" required value="<?php echo $cliente->cep ?? ""; ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="telefone" placeholder="telefone" pattern="[0-9]{2,3}[0-9]{8,16}" required value="<?php echo $cliente->telefone ?? ""; ?>">
            </div>
            <div class="form-group">
        ...
        if(isset($_POST['alterar'])) {
            ...
            $clienteAlterar->nome = Padronizacao::padronizarMaiusculasMinusculas($_POST['nome']);
            $clienteAlterar->sexo = $_POST['sexo'];
            $clienteAlterar->dataNascimento = $_POST['dataNascimento'];
            $clienteAlterar->cep = $_POST['cep'];
            $clienteAlterar->numeroCasa = $_POST['numeroCasa'];
            $clienteAlterar->telefone = $_POST['telefone'];
