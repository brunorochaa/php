...
<html lang="pt-br">
    ...
    <body>
        ...
        <form name="cadastro" method="post" action="control/control.php">
            ...
            <div class="form-group">
                <input type="text" name="nomeMecanico" placeholder="nome" pattern="[0-9a-zA-ZãÃáÁàÀêÊéÉèÈíÍìÌôÔõÕóÓòÒúÚùÙûÛçÇ ]{2,100}" required value="<?php if(isset($post)) echo $post['nomeMecanico']; ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="placa" placeholder="placa do carro" pattern="[A-Z]{3}-[0-9]{4}" required value="<?php if(isset($post)) echo $post['placa']; ?>">
            </div>
