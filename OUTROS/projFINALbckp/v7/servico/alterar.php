...
<html lang="pt-br">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="alterar.php">ALTERAR DADOS<span class="sr-only"></span></a></li>
        ...
        <h1 class="jumbotron titulo">Alterar Dados</h1>
        <?php
        ...
        <form name="alterar" method="post" action="alterar.php">
            ...
            <div class="form-group">
                <input type="text" name="nomeMecanico" placeholder="nome" pattern="[0-9a-zA-ZãÃáÁàÀêÊéÉèÈíÍìÌôÔõÕóÓòÒúÚùÙûÛçÇ ]{2,100}" required value="<?php echo $servico->nomeMecanico ?? ""; ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="placa" placeholder="placa do carro" pattern="[A-Z]{3}-[0-9]{4}" required value="<?php echo $servico->placa ?? ""; ?>">
            </div>
        ...
        if(isset($_POST['alterar'])) {
            ...
            $servicoAlterar->descricaoServico = Padronizacao::padronizarMaiusculasMinusculas($_POST['descricaoServico']);
            $servicoAlterar->filial = $_POST['filial'];
            $servicoAlterar->nomeMecanico = Padronizacao::padronizarMaiusculasMinusculas($_POST['nomeMecanico']);
            $servicoAlterar->carro = Padronizacao::padronizarMaiusculasMinusculas($_POST['carro']);
            $servicoAlterar->cor = Padronizacao::padronizarMaiusculasMinusculas($_POST['cor']);
            $servicoAlterar->placa = $_POST['placa'];
            $servicoAlterar->tipoCombustivel = $_POST['tipoCombustivel'];
            $servicoAlterar->urgencia = $_POST['urgencia'];
